...
urlpatterns = [
    ...
    path('average-spending/', views.CalculateAverageSpendingView.as_view(), name='average-spending'),

    # RF13 — Motor de elegibilidad
    path('eligibility/', views.EvaluateEligibilityView.as_view(), name='evaluate-eligibility'),
